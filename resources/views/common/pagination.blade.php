@if($paginator->hasPages()) 
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" @if ($paginator->currentPage() == 1) style="pointer-events: none; color: grey" @endif href="{{$paginator->previousPageUrl()}}">{{ trans('localization.previous')}}</a></li>
        ...
        @endif  
            ...
            <li class="page-item"><a class="page-link" @if (!$paginator->hasMorePages()) style="pointer-events: none; color: grey" @endif href="{{$paginator->nextPageUrl()}}">{{ trans('localization.next')}}</a></li>
